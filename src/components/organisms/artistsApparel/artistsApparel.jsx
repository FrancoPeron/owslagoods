...
import './artistsApparel.scss'

// Router
import { Link } from "react-router-dom";

const ArtistsApparel = () => {
  ...
  return (
    <section className='artists-apparel'>
      ...
      <img className='artists-apparel__img1' src={imgArtists1} alt="" />
      <img className='artists-apparel__img2' src={imgArtists2} alt="" />
      <img className='artists-apparel__img3' src={imgArtists3} alt="" />
