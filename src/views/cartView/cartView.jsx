...
// Components
import Checkout from "@/components/organisms/checkout/checkout.jsx"
...
const cartView = () => {
  ...
  return (
    <main className="bag">
      <h2 className="bag__title">My Bag</h2>
                ...
                <button className="trash__btn" onClick={() => { removeItem(item.id) }}>
                  <svg className="trash__ico cursor-pointer p-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
                    <g transform="translate(-89.25 -860.75)">
                      <line className="trash__ico-a" x2="24" transform="translate(90.5 867)"></line>
                      <path className="trash__ico-b" d="M2,0h8a2,2,0,0,1,2,2V5a0,0,0,0,1,0,0H0A0,0,0,0,1,0,5V2A2,2,0,0,1,2,0Z" transform="translate(96.5 862)"></path>
                      <path className="trash__ico-b" d="M0,0H18L16,17a3,3,0,0,1-3,3H5a3,3,0,0,1-3-3Z" transform="translate(93.5 867)"></path>
                    </g>
                  </svg>
                  <p className="trash__btn-title">remove</p>
                </button>
              </div>
            ))}
